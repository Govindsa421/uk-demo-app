  ...
  const card = [
    {
      ...
      icon: <CustomIcon icon="compass2" size={30} color="gray" />,
    ...
    },
    {
      ...
      icon: <CustomIcon icon="feed" size={30} color="gray" />,
    ...
    },
    {
      ...
      icon: <CustomIcon icon="stats-bars" size={30} color="gray" />,
            ...
            return (
              ...
              >
                <div className="mx-auto">
                  <p className="group-hover:bg-white bg-gray-200 rounded-full p-3">
                    {crd.icon}
                  </p>
                  {/* <Image
                    src={crd.img}
